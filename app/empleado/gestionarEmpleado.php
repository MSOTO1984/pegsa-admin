...
class GestionarEmpleado {

    var $order = 2;
    var $tabla = "tab_empleados";
    var $nombre = "Empleado";
    var $nombres = "Empleados";
    var $mensaje = "El Empleado";
    var $llave = "codEmpleado";
    var $campos = array("codEmpleado", "nomEmpleado", "emailEmpleado", "nomEstado", "usuarioCreacion", "fechaCreacion");
    var $columnas = array("Opciones", "Identificaci&oacute;n", "Nombre", "Email", "Estado", "Usuario creaci&oacute;n", "Fecha creaci&oacute;n");
    ...
    function vista($accion) {
        ...
        $params2['ruta'] = "js/empleado/empleado";
        $form->linkJs($params2);
        ...
        $form->inicioDiv("col-lg-4");
        $form->text(array("label" => "Nombre", "id" => "nomEmpleado", "required" => "1"));
        $form->finDiv();

        $form->inicioDiv("col-lg-4");
        $form->text(array("label" => "Email", "type" => "email", "id" => "emailEmpleado", "required" => "1"));
        $form->finDiv();
        ...
        $form->inicioDiv("col-lg-4");
        $form->text(array("label" => "Celular", "type" => "text", "id" => "celEmpleado", "required" => "1"));
        $form->finDiv();
        ...
        $form->botonAcciones(array(
            ...
            "icon" => "fa fa-plus",
            "label" => $accion,
            "onclick" => "return validarEmpleado()"
        ));
        $form->botonAcciones(array(
            "link" => true,
            "type" => "button",
