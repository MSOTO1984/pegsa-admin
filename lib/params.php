...
define("BACKGROUND", "bg-aqua");
define("BACKGROUND2", "bg-navy");
define("BACKGROUND3", "bg-gray");

define("MIBASE", "helpu1_fegsa_admin_bd");
define("MIUSER", "helpu1_administrador");
define("MIPASS", "CObO%s%{_U#^");

#define("MIBASE", "pegsa_admin_bd");
#define("MIUSER", "root");
#define("MIPASS", "");
