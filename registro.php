...
<html class="<?php echo BACKGROUND; ?>">
    ...
    <body class="<?php echo BACKGROUND; ?>">
        <div class="form-box" id="login-box">
            <div class="header <?php echo BACKGROUND2; ?>">Registro de Usuarios</div>
            <div class="body <?php echo BACKGROUND3; ?>">
                <div class="form-group">
                    <input type="text" name="codUsuario" id="codUsuario" class="form-control" placeholder="Nro. Documento" required/>
                </div>
                <div class="form-group">
                    <input type="text" name="nomUsuario" id="nomUsuario" class="form-control"  placeholder="Nombre Completo" required/>
                </div>
                <div class="form-group">
            ...
            <div class="footer">
                <button type="button" class="btn <?php echo BACKGROUND2; ?> btn-block" id="state" name="state" value="Registrarme" onclick="return validarRegistro()">      
                    Registrarme  
                </button>
